...
#
# Adapter from ODK to use with ODKAI.
#
...
# we diverge from ODK here
ODK_IMAGE=cmungall/odk-ai
...
echo "ODK_IMAGE: $ODK_IMAGE"
echo "ODK_TAG: $ODK_TAG"
echo "ODK_JAVA_OPTS: $ODK_JAVA_OPTS"
echo "ODK_DEBUG: $ODK_DEBUG"
echo "ODK_USER_ID: $ODK_USER_ID"
echo "ODK_GROUP_ID: $ODK_GROUP_ID"
echo "VOLUME_BIND: $VOLUME_BIND"
